    ...
    return Container(
      ...
      child: Column(
        ...
        children: const <Widget>[
          ...
          Text(
            StringConstants.onboardingFirstTitle,
            style: TextStyle(
              fontSize: 30,
              color: Colors.white,
          ...
          SizedBox(height: 10),
          Text(
            StringConstants.onboardingFirstDesc,
            style: TextStyle(
              fontSize: 15,
              color: Colors.white,
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: const <Widget>[
          ...
          Text(
            StringConstants.onboardingSecondTitle,
            style: TextStyle(
              fontSize: 30,
              color: Colors.white,
              fontWeight: FontWeight.bold,
          ...
          SizedBox(height: 10),
          Text(
            StringConstants.onboardingSecondDesc,
            style: TextStyle(
              fontSize: 15,
              color: Colors.white,
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const Text(
            StringConstants.onboardingThirdTitle,
            style: TextStyle(
              fontSize: 30,
              color: Colors.white,
              fontWeight: FontWeight.bold,
