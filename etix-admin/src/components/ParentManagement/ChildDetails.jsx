...
import { USER_PARENT_UPDATE_REQUEST, USER_PARENT_UPDATE_RESET, CHILDREN_DETAILS_REQUEST, USER_PARENT_UPDATE_SUCCESS, USER_PARENT_UPDATE_FAIL, USER_UPDATE_RESET, USER_DETAIL_RESET, CHILDREN_DETAILS_RESET, INDIVIDUAL_TEACHER_RESET, INDIVIDUAL_PARENT_RESET, CHILDREN_ADD_RESET } from '../../constants/userConstants';
...
const Parent = ({props}) => {
    ...
    const handleFindChildren = () => {
        history.push(`/menu/Parentmanagement/children/${parentID}`)
    }
                                                        ...
                                                        <Grid item xs = {12} container >
                                                            ...
                                                            {childData.length > 1 ?
                                                                    ...
                                                                    {editing?
                                                                        <>
                                                                            ...
                                                                            <Button 
                                                                                ...
                                                                                style={{cursor: 'pointer', backgroundColor: '#4caf50', color: 'white', fontWeight: 'bold', fontFamily: ['rubik', 'sans-serif'].join(',') , marginTop: 20, marginBottom: 20}}
                                                                                onClick={handleFindChildren}
                                                                            >
                                                                            ...
                                                                            <Button 
                                                                                variant="contained"
                                                                                startIcon={<AddIcon />}
                                                                                style={{cursor: 'pointer', backgroundColor: 'red', color: 'white', fontWeight: 'bold', fontFamily: ['rubik', 'sans-serif'].join(',') , marginTop: 20, marginBottom: 20}}
                                                                ...
                                                                <Button 
                                                                        variant="contained"
                                                                        startIcon={<AddIcon />}
                                                                        style={{cursor: 'pointer', backgroundColor: 'green', color: 'white', fontWeight: 'bold', fontFamily: ['rubik', 'sans-serif'].join(',') , marginTop: 20, marginBottom: 20}}
