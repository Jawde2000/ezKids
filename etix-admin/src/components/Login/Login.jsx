...
import PrincipalBackground from '../globalAssets/PrincipalBackground.webp';
import LockIcon from '@mui/icons-material/Lock';
import LoginForm from './LoginForm';

const useStyles = makeStyles((theme) => ({
    whole: {
      backgroundImage: `url(${PrincipalBackground})`,
              ...
              <Box className={defaultStyle.urlVerification}>
                ...
                <Grid item>
                  <Typography style={{fontFamily: ['rubik', 'sans-serif'].join(','), fontSize: 18, display: "flex", opacity: 1,}}>
                    url verification: <Link style={{textDecoration: "none"}}><span className={defaultStyle.urlText}><span className={defaultStyle.lime}>https://</span>ezkids.io</span></Link>
                  </Typography>
                </Grid>
              </Box>
            </Grid>
